      ...
      <AnimatePresence>
        {showMenu && isAuthenticated && (
          ...
          >
            ...
            <div className="p-2">
              <button onClick={handleSave} className="w-full flex items-center gap-3 px-3 py-2 text-sm text-white/80 hover:bg-white/5 rounded-lg">
                <Save className="w-4 h-4" />
                Salvar projeto
              </button>

              <button onClick={onExport} className="w-full flex items-center gap-3 px-3 py-2 text-sm text-white/80 hover:bg-white/5 rounded-lg">
                <Download className="w-4 h-4" />
                Exportar
              </button>

              <button onClick={handleSync} className="w-full flex items-center gap-3 px-3 py-2 text-sm text-white/80 hover:bg-white/5 rounded-lg">
            ...
            <div className="p-2 border-t border-white/10">
              <button onClick={handleLogout} className="w-full flex items-center gap-3 px-3 py-2 text-sm text-red-400 hover:bg-red-500/10 rounded-lg">
...
const EditorInterface: React.FC = () => {
  ...
  const { viewMode, currentProject } = useProjectStore();
...
}; // <-- CORRETO: fecha o EditorInterface
